    ...
    public class BounceEffect : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerClickHandler
    {
        ...
        private void Shrink()
        {
            ...
            var shrinkTween = transform
                .DOScale(_shrinkScale, _shrinkDuration)
                .SetEase(_shrinkEase);

            _shrinkSequence.Append(shrinkTween).Play();
        }
        ...
        private void BounceBack()
        {
            ...
            var bounceTween = transform
                .DOScale(Vector3.one, _bounceBackDuration)
                .SetEase(_bounceBackEase);

            _bounceSequence.Append(bounceTween).Play();
        }
